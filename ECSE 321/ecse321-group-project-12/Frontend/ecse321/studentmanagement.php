                ...
                <div class="row">
                            ...
                            <div class="border border ">
                                ...
                                <form class=" user" method="post" action="">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="studentname" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter a student name">
                                        <br>
                                        <input type="number" class="form-control form-control-user" name="studentId" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter student's McGill Id">
                                        <br>
                                        <input type="email" class="form-control form-control-user" name="studentEmail" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter student's email.">
                    ...
                    <div class="col-lg-7">
                        <div class="  p-5">
                            <div class="border border ">
                                <div class=" text-center" >
                                    <h1 class="h4 text-gray-900 mb-4">Delete a Student</h1>
                                </div>
                                <form class=" user" method="post" action="">
                                    <div class="form-group">
                                        <input type="text" class="form-control form-control-user" name="deletestudent" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Enter a student name">
                                    </div>
                                    <br><br>
                            ...
                            <?php if(isset($_SESSION['deletesuc'])) {
                                echo ("<div class=\"alert alert-success\">
                                            <strong>Success!</strong> 
                                            </div>");
...
if (isset($_POST['submitbut'])) {
    if (isset($_POST['studentname'])) {
        $newStudName = '';
        $newStudName = str_replace(" ","+",$_POST['studentname']);

        $addStud = 'https://ecse321-group12.herokuapp.com/studentsf?userName='.$newStudName.'&mcgillid='.$_POST['studentId'].'&email='.$_POST['studentEmail'];
