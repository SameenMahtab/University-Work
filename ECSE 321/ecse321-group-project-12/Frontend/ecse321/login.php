...
<body class="bg-gradient-primary" id="body">
  ...
  <div class="container" name="maincontainer" id="maincontainer" style="padding-top: 8rem;">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  <div class="text-center">
                    <h1 class="h4 text-gray-900 mb-4">McGill MyCoop</h1>
                  </div>
...
if (isset($_GET['submit'])) {
    if (isset($_GET['username']) && (isset($_GET['password']))) {
        $login = 'https://ecse321-group12.herokuapp.com/login?username='.$_GET['username'].'&password='.$_GET['password'];

       // $_GET['login'] = $login;

        $cSession = curl_init();
        curl_setopt($cSession,CURLOPT_URL,$login);
